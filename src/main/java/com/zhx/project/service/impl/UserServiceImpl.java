...
import com.zhx.project.model.vo.user.resp.LoginResp;
import com.zhx.project.model.vo.userInterfaceInfo.resp.UserVO;
import com.zhx.project.service.LoginService;
import com.zhx.project.service.UserService;
import com.zhx.project.utils.RequestHolder;
...
import static com.zhx.project.constant.UserConstant.ADMIN_ROLE;
import static com.zhx.project.constant.UserConstant.USER_LOGIN_STATE;
...
public class UserServiceImpl extends ServiceImpl<UserMapper, User>
    ...
    @Override
    public LoginResp userLogin(String userAccount, String userPassword, HttpServletRequest request) {
        // 1. 校验
        ...
        BeanUtil.copyProperties(userVO, loginResp);
        //获取token
